...
namespace Modbus.ModbusFunctions
{
    ...
    public abstract class ModbusFunction : IModbusFunction
	{
		...
		// identifikator transakcije, protokol id je ugl 0 za modbus
		// duzina poruke, unitid = identifikator uredjaja sa kojim komuniciramo
		// functionCode = akcija koju zelimo da izvrsimo (citanje analog/dig, pisanje )
		...
		/// Provera tipa parametara , m mora biti tipa t
        /// </summary>
		...
		/*
		 Dictionary mapira Tuple(tip i adresu tacke) na vrednost primljenu od modbusa
		npr : PointType je analog_input adresa 1000, a vrednost ce biti primljena
		od modbusa za taj ulaz na toj adresi
		 */
